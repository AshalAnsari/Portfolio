  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        const Responsive(
          desktop:
              AnimatedSubtitleText(start: 30, end: 40, text: 'MERN STACK '),
          largeMobile:
              AnimatedSubtitleText(start: 30, end: 25, text: 'MERN STACK '),
          mobile: AnimatedSubtitleText(start: 25, end: 20, text: 'MERN STACK '),
          tablet: AnimatedSubtitleText(start: 40, end: 30, text: 'MERN STACK '),
        ),
